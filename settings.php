...
<form action="<?php echo ossn_installation_paths()->url; ?>?action=install" method="post">
    ...
    <div class="mb-4">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                <input class="form-control" type="text" value="root" name="dbuser" readonly="readonly"  placeholder="<?php echo ossn_installation_print('ossn:dbuser'); ?>" />
            </div>
            <div class="col-md-6">
                <input class="form-control" type="password" value="<?php echo $password;?>" name="dbpwd"  readonly="readonly" placeholder="<?php echo ossn_installation_print('ossn:dbpassword'); ?>" />
            </div>
        </div>

        <div class="row g-3">
            <div class="col-md-6">
                <input class="form-control" type="text" name="dbname" value="ossndb" readonly="readonly"  placeholder="<?php echo ossn_installation_print('ossn:dbname'); ?>" />
            </div>
            <div class="col-md-6">
                <input class="form-control" type="text" name="dbhost" value="localhost" readonly="readonly"  placeholder="<?php echo ossn_installation_print('ossn:dbhost'); ?>" />
            </div>
        </div>
    </div>
